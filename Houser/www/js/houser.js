...
/* file: js/app.js */
HOUSER.define('js/Libs/phone_gap',['require'],function (require) {
    var app = {
...
HOUSER.require(['js/core', 'js/Libs/phone_gap', 'js/Libs/parse'], function(core, phoneGap, parse) {
...
HOUSER.define("js/main", function(){});
